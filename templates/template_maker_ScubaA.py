...
im = cv2.imread("B551_TypeA_2.png") 
...
img_contrast_rot = rotateImage(img_as_ubyte(img_contrast), -0.1)
...
tl = np.array([300,500])
br = tl + np.array([370,440])

plt.imsave('Scuba_A_template.png', img_contrast_rot[tl[1]:br[1],tl[0]:br[0]], cmap=plt.cm.gray)

cv2.rectangle(img_contrast_rot,(tl[0],tl[1]), (br[0],br[1]), 255, 5)
cv2.circle(img_contrast_rot,(tl[0]+183,tl[1]+270), 10, (255), 10)
