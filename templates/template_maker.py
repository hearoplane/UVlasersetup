...
im = cv2.imread("NSC_shielded.png") 
...
img_contrast_rot = rotateImage(img_as_ubyte(img_contrast), -0.5)
...
tl = np.array([185,460])
br = tl + np.array([300,460])
plt.imsave('ShieldedNSC_template.png', img_contrast_rot[tl[1]:br[1],tl[0]:br[0]], cmap=plt.cm.gray)

cv2.rectangle(img_contrast_rot,(tl[0],tl[1]), (br[0],br[1]), 255, 5)
cv2.circle(img_contrast_rot,(tl[0]+150,tl[1]+193), 10, (255), 10)
