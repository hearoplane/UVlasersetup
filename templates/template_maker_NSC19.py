...
im = cv2.imread("NSC19_B616_1_b4c.png") 
...
img_contrast_rot = rotateImage(img_as_ubyte(img_contrast), -1.0)
...
tl = np.array([360,420])
br = tl + np.array([360,480])
plt.imsave('NSC19_template.png', img_contrast_rot[tl[1]:br[1],tl[0]:br[0]], cmap=plt.cm.gray)

cv2.rectangle(img_contrast_rot,(tl[0],tl[1]), (br[0],br[1]), 255, 5)
cv2.circle(img_contrast_rot,(tl[0]+180,tl[1]+240), 10, (255), 10)
