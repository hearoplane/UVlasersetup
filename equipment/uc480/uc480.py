...
class camera(HCAM):
	...
	def SetIntegTime(self, iTime):
		#self.__selectCamera()
		newExp = ctypes.c_double(0)
		newFrameRate = ctypes.c_double(0)
		ret = CALL('SetFrameRate', ctypes.c_double(1.0e3/iTime), ctypes.byref(newFrameRate))
		print ret
		if ret == 0:
			print "Error in SetFrameRate"
		
		ret = CALL('SetExposureTime', ctypes.c_double(iTime), ctypes.byref(newExp))
		if ret == 0:
			print "Error in SetExposureTime"
	...
	def AllocImageMem(self,width=None,height=None,bitpixel=8):
